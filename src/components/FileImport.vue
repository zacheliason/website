<template lang="html">
  <div>
    ...
    <div class="frontpage" v-if="front_page">
      <h1>Request Spotify Data</h1>
      <p>As of the time of writing this you can request your data at the bottom of your account's <a target="_blank" href="https://www.spotify.com/us/account/privacy/">Privacy Settings</a> page (gathering streaming history can take up to 5 days). After you get the download email, click next.</p>
      <h2 class="next-button" v-on:click="change_page">Next »</h2>
    ...
    <div class="backpage" v-if="!front_page">
      <div class="import_data" v-if="import_pending">
        <h1>Import Data</h1>
        <p>Your zipped data file should include some <span class="mono">StreamingHistoryJSON</span> files starting from <span class="mono">0</span>. Add each of them in order, then press <span class="mono">create</span> to view your streamgraph.<br /></p>
        <p>
          <h2 class="next-button" @click="change_page">« Request Spotify Data</h2>
        </p>
        <hr />
        <div class="left">
          <div class="box">
